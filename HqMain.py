...
conn = pymysql.connect(host="localhost",user="root",passwd="",db="mstock",charset="utf8")
cursor=conn.cursor()
...
# mHsUpdater.createTableHs("sh")
# mHsUpdater.createTableHs("sz")   
mHsUpdater.updateListsh("input/20171203深圳A股列表.xlsx")
mHsUpdater.updateListsz("input/20171203上海A股列表.xlsx")
